                ...
                var citems = {
                        "filter" : {name: "过滤", items: 
                         { 
                                ...
                                "clearfilter": {name: "清除过滤器" }
                         }},
                        "limit" : {name: "限定结果条数", items: 
                        {
                                "TopCount###SEPARATOR###10": {name: "前10名" },
                                "BottomCount###SEPARATOR###10": {name: "末10名" },
                                "TopCountQuick" : { name: "前10名，根据...", items: addFun(items, "TopCount") },
                                "BottomCountQuick" : { name: "末10名，根据...", items: addFun(items, "BottomCount") },
                                "customtop" : {name: "自定义..." },
                                "clearlimit" : {name: "清除限定条件"}
                         }},
                        "sort" : {name: "排序", items:
                        {
                            //"ASCQuick": {name: "正序" , items: addFun(items, "ASC") },
                            //"DESCQuick": {name: "倒序", items: addFun(items, "DESC")},
                            "BASCQuick": {name: "正序", items: addFun(items, "BASC")},
                            "BDESCQuick": {name: "倒序", items: addFun(items, "BDESC") },
                            "customsort" : { name: "自定义..." },
                            "clearsort" : {name: "清除排序" }
                        }}
                };
