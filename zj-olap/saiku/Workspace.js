...
var Workspace = Backbone.View.extend({
    ...
    caption: function(increment) {
        ...
        return "<span class='i18n'>没保存的查询</span> (" + (Saiku.tabs.queryCount) + ")";
    },
    ...
    render_result: function(args) {
        ...
        */
        var info = '<b><span class="i18n">信息:</span></b> &nbsp;' + cdate 
    ...
    cancelled: function(args) {
        this.processing.html('<span class="processing_image">&nbsp;&nbsp;</span> <span class="i18n">取消查询中。。。</span>').show();
    },

    no_results: function(args) {
        this.processing.html('<span class="i18n">没有查询结果。。</span>').show();
    },
