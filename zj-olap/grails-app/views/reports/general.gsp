...
<html>
	...
	<body>
		...
		<div id="create-sales" class="scaffold-create" role="main">
			<h1>总体经营分析报表</h1>
		...
		<div id="report-content" class="content scaffold-list"  role="main">
		<g:if test="${result }">
			<table>
				<thead>
					<tr>
